...
<style>
    ...
    .tag { display: inline-flex; align-items: center; font-size: 0.68rem; font-weight: 700; padding: 4px 11px; border-radius: 20px; white-space: nowrap; }
...
<div class="dash">
    ...
    <div class="page-header">
        <h4 class="page-title"><i class="fa-solid fa-user-pen"></i> Editar Usuário</h4>
    ...
    <form action="{{ route('usuarios.update', $usuario->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-card">
            <div class="form-card-header">
                <div class="form-card-header-left">
                    ...
                    <span class="title">#{{ $usuario->id }} — {{ Str::limit($usuario->nome, 35) }}</span>
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="tipo" class="form-select @error('tipo') is-invalid @enderror" required onchange="togglePrestador(this.value)">
                            ...
                            <option value="prestador" {{ old('tipo', $usuario->tipo) === 'prestador' ? 'selected' : '' }}>Prestador</option>
                            <option value="adm"       {{ old('tipo', $usuario->tipo) === 'adm'       ? 'selected' : '' }}>ADM</option>
                        </select>
        ...
        {{-- Dados do prestador --}}
        <div id="campos-prestador" class="form-card {{ old('tipo', $usuario->tipo) !== 'prestador' ? 'd-none' : '' }}">
            <div class="form-card-header">
                <div class="form-card-header-left">
                    <i class="fa-solid fa-briefcase"></i>
                    <span class="title">Dados do Prestador</span>
                </div>
            </div>
            <div class="form-card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="cpf_cnpj" class="form-control" value="{{ old('cpf_cnpj', $usuario->cpf_cnpj) }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Razão Social</label>
                        <input type="text" name="razao_social" class="form-control" value="{{ old('razao_social', $usuario->razao_social) }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Nome Fantasia</label>
                        <input type="text" name="nome_fantasia" class="form-control" value="{{ old('nome_fantasia', $usuario->nome_fantasia) }}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-card">
            <div class="form-card-footer">
                <a href="{{ route('usuarios.show', $usuario->id) }}" class="btn-view">
                    <i class="fa-solid fa-eye"></i> Ver Usuário
                </a>
